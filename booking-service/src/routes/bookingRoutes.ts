...
router
  ...
  .get(
    authenticateToken,
    bookingController.getBookingsByStudentId.bind(bookingController)
  );
...
router
  ...
  .get(
    authenticateToken,
    bookingController.getBookingsByInstructorId.bind(bookingController)
  );
...
router
  ...
  .get(
    authenticateToken,
    bookingController.getBookindDataById.bind(bookingController)
  );
