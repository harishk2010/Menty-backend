...
export default interface IBookingController{
    ...
    getBookingsByInstructorId(req:Request,res:Response,next:NextFunction):Promise<void>
    getBookindDataById(req:Request,res:Response,next:NextFunction):Promise<void>
}