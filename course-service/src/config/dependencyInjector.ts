...
import { IInstructorDashboardController } from "../controllers/interfaces/IInstructorDashboardController";
import { InstructorDashboardController } from "../controllers/instructorDashboard/InstructorDashboardController";
import { IInstructorDashboardService } from "../services/interfaces/IInstructorDashboardService";
import { InstructorDashboardService } from "../services/instructorDashboard/InstructorDashboardService";
import { IInstructorDashboardRepository } from "../repositories/interfaces/IInstructorDashboardRepository";
import { InstructorDashboardRepository } from "../repositories/instructorDashboard/InstructorDashboardRepository";
...
const chapterController: IChapterControllers = new ChapterController(
  chapterService
);
...
const instructorDashboardRepository: IInstructorDashboardRepository =
  new InstructorDashboardRepository();
const instructorDashboardService: IInstructorDashboardService =
  new InstructorDashboardService(instructorDashboardRepository);
const instructorDashboardController: IInstructorDashboardController =
  new InstructorDashboardController(instructorDashboardService);
