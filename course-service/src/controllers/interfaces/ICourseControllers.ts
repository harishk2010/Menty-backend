...
export interface ICourseControllers {
    ...
    getFilteredInstructorCourses(req:Request,res:Response,next:NextFunction):Promise<void>
    ...
    getPaginatedCourses(req: Request, res: Response, next:NextFunction):Promise<void>
    getCourseCategories(req: Request, res: Response, next:NextFunction):Promise<void>
